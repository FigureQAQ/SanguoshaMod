...
- 五个角色拥有三国化命名；武魂以初始遗物形式提供，并驱动各自的杀附魔机制。
...
角色不再只依赖官方的角色专属打击牌，而是通过初始遗物“武魂”把所有杀接入不同的附魔路线。
...
| 汉室仁主 | 君王之剑 | 每回合生成王剑杀，消耗辉星打出；消耗牌堆越多伤害越高。 |
...
| --- | --- | --- |
| 初始牌组 | 以角色自己的打击、防御和少量特色牌开局。 | 以杀、闪、桃、酒为共同语言，再由初始遗物武魂改变杀的属性和收益。 |
...
| 汉室仁主 | 君王之剑 | 依靠辉星打出王剑杀，并用消耗牌堆提升伤害。 |
