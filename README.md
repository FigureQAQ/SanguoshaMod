...
[最新 Release：v0.1.13-multiplayer](https://github.com/FigureQAQ/SanguoshaMod/releases/tag/v0.1.13-multiplayer)
...
| 汉室仁主 | 号令杀 | 号令随回合成长，杀命中后追加等同号令的伤害。 |
...
| 汉室仁主 | 号令杀 | 用稳定成长的号令强化杀，并让首张技能牌回能。 |
