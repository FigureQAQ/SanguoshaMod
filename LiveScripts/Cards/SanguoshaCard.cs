    ...
    : ModCardTemplate(baseCost, type, rarity, target, showInCardLibrary)
{
    internal static readonly IReadOnlyDictionary<string, string> PortraitSlugs = new Dictionary<string, string>
    {
        ["BaGuaCard"] = "bagua",
        ["BaiYinCard"] = "baiyin",
        ["BathOfBloodCard"] = "bathofblood",
        ["BingLiangCard"] = "bingliang",
        ["BuFangCard"] = "bufang",
        ["ChiTuCard"] = "chitu",
        ["CiShaCard"] = "cisha",
        ["CrimsonRaidCard"] = "kurou",
        ["DaWanCard"] = "dawan",
        ["DiLuCard"] = "dilu",
        ["DiaoDuCard"] = "diaodu",
        ["DuelCard"] = "duel",
        ["EdictReserveCard"] = "imperialedict",
        ...
        ["LongDanCard"] = "longdan",
        ["LuoYiCard"] = "luoyi",
        ["ImperialEdictCard"] = "imperialedict",
        ["MengDeXinShuCard"] = "mengdexinshu",
        ["MuNiuCard"] = "muniu",
        ["NanManCard"] = "nanman",
        ["NightfallSchemeCard"] = "nightfallscheme",
        ["QiLinCard"] = "qilin",
        ["QiXiCard"] = "qixi",
        ["PoZhenCard"] = "pozhen",
        ["PoZhuCard"] = "pozhu",
        ["QingNangCard"] = "qingnang",
        ...
        ["SoulHealerFormCard"] = "soulhealerform",
        ["SoulRansomCard"] = "soulhealerform",
        ["TaiPingCard"] = "taiping",
        ["TaoCard"] = "tao",
        ["TaoYuanCard"] = "taoyuan",
        ["TengJiaCard"] = "tengjia",
        ["ThunderMandateCard"] = "thundermandate",
        ["ThunderRelayCard"] = "thundermandate",
        ["TieSuoCard"] = "tiesuo",
        ["TieQiCard"] = "tieqi",
        ["TuXiCard"] = "tuxi",
        ["VenomAmbushCard"] = "huogong",
        ["WanJianCard"] = "wanjian",
        ["WuGuCard"] = "wugu",
