...
internal static class SanguoshaLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, Entry> Text = new Dictionary<string, Entry>
    {
        ...
        ["SANGUOSHA_CARD_TIE_SUO_CARD.description"] = new("cards", "施加 {Slow:diff()} 层减速。本回合你的杀会对其他敌人造成 75% 伤害；升级后为 100%。判定抽牌堆顶 1 张牌并置入弃牌堆；若判定牌是锦囊或能力牌，其他敌人受到 {Damage:diff()} 点伤害并获得 {Energy:diff()} 点能量，否则抽 {Draw:diff()} 张牌。"),
