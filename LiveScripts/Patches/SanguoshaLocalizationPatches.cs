...
internal static class SanguoshaLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, Entry> Text = new Dictionary<string, Entry>
    {
        ...
        ["SANGUOSHA_CARD_BING_LIANG_CARD.description"] = new("cards", "判定抽牌堆顶 1 张牌并置入弃牌堆。若判定牌费用为 0，抽 {Draw:diff()} 张牌；否则施加 {Weak:diff()} 层虚弱和 {Slow:diff()} 层减速。若判定牌是技能牌、能力牌或费用不低于 2，额外施加 {JudgedWeak:diff()} 层虚弱和 {JudgedSlow:diff()} 层减速。"),
        ...
        ["SANGUOSHA_CARD_MENG_DE_XIN_SHU_CARD.description"] = new("cards", "装备：宝物。获得 {Energy:diff()} 点能量并抽 {Draw:diff()} 张牌。每回合首次打出技能牌后，获得 1 点能量，并使至多 {FreeCards:diff()} 张杀或技能牌本回合变为 0 费。失去时获得能量并临时减费。"),
        ...
        ["SANGUOSHA_CARD_TIE_SUO_CARD.description"] = new("cards", "施加 {Slow:diff()} 层减速。本回合你的杀会对其他敌人造成 {SplashPercent:diff()}% 伤害。判定抽牌堆顶 1 张牌并置入弃牌堆；若判定牌是技能牌或能力牌，其他敌人受到 {Damage:diff()} 点伤害并获得 {Energy:diff()} 点能量，否则抽 {Draw:diff()} 张牌。"),
        ...
        ["SANGUOSHA_CARD_LONG_DAN_CARD.description"] = new("cards", "获得 {Block:diff()} 点格挡。此后每回合第一张杀或闪本回合费用变为 0。"),
        ...
        ["SANGUOSHA_CARD_LIAN_YING_CARD.description"] = new("cards", "能力牌。抽 1 张牌。每回合前 {Triggers:diff()} 次你打出牌后没有手牌时，抽 {Draw:diff()} 张牌，并使其中 1 张杀或技能牌本回合变为 0 费。"),
        ["SANGUOSHA_CARD_YI_JI_CARD.title"] = new("cards", "遗计"),
        ["SANGUOSHA_CARD_YI_JI_CARD.description"] = new("cards", "能力牌。抽 1 张牌。每回合首次敌人即将对你造成伤害时，抽 {Draw:diff()} 张牌；若手牌不多，额外抽 {LowHandDraw:diff()} 张牌，并使至多 {FreeCards:diff()} 张杀或技能牌本回合变为 0 费。"),
        ...
        ["SANGUOSHA_CARD_REN_DE_CARD.description"] = new("cards", "弃 1 张手牌，回复 {Heal:diff()} 点生命并抽 {Draw:diff()} 张牌。若弃杀，下一张杀额外造成 {NextShaDamage:diff()} 点伤害；若弃闪，获得 {Block:diff()} 点格挡；若弃技能牌，获得 {Energy:diff()} 点能量。"),
        ...
        ["SANGUOSHA_CARD_QI_XI_CARD.description"] = new("cards", "消耗 1 张技能牌，若目标有格挡，移除其所有格挡并施加 {Vulnerable:diff()} 层易伤；若目标没有格挡，抽 {Draw:diff()} 张牌并获得 1 点能量。"),
        ...
        ["SANGUOSHA_POWER_MENG_DE_XIN_SHU_DISPLAY_POWER.description"] = new("powers", "装备：宝物。每回合首次打出技能牌后获得能量，并使杀或技能牌本回合变为 0 费。失去时获得能量并临时减费。"),
        ...
        ["SANGUOSHA_POWER_LONG_DAN_DISPLAY_POWER.description"] = new("powers", "每回合第一张杀或闪本回合费用变为 0。"),
        ...
        ["SANGUOSHA_POWER_LIAN_YING_DISPLAY_POWER.description"] = new("powers", "能力牌。打出牌后若没有手牌，抽牌并让 1 张杀或技能牌本回合变为 0 费。"),
        ...
        ["NECROBINDER.description"] = new("characters", "青囊魂医以魂术济危：所有杀视为灾厄杀，命中后施加灾厄，并以魂值换取吸血式追击。"),
        ...
        ["SANGUOSHA_RELIC_NECROBINDER_SKILL_RELIC.description"] = new("relics", "青囊魂医的武魂。战斗开始回复生命并获得魂值；你的杀均为灾厄杀，命中后施加灾厄并获得魂值。魂值达到 4 时消耗 4，回复 2 点生命并追加 4 点伤害。"),
        ["SANGUOSHA_POWER_CALAMITY.title"] = new("powers", "灾厄"),
        ["SANGUOSHA_POWER_CALAMITY.description"] = new("powers", "灾厄杀施加的负面效果。"),
        ...
        ["SANGUOSHA_RELIC_REGENT_SKILL_RELIC.description"] = new("relics", "汉室仁主的武魂。战斗开始获得号令和星辉；你的杀均为储能杀，命中后追加较少的号令伤害并获得储能。每 2 点储能自动消耗，获得 1 点能量并抽 1 张牌。星辉达到 3 时消耗 3，发动诏令：获得 1 点能量、抽 1 张牌、提升 1 点号令，并使 1 张杀或技能牌本回合免费。"),
