...
internal static class SanguoshaLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, Entry> Text = new Dictionary<string, Entry>
    {
        ...
        ["SANGUOSHA_CARD_JIU_CARD.description"] = new("cards", "你的下一张攻击牌造成的伤害翻倍。升级后不再消耗。"),
        ...
        ["SANGUOSHA_CARD_ZHU_GE_CARD.description"] = new("cards", "装备：武器。获得 {Strength:diff()} 点力量并生成 1 张免费杀。每回合开始时，手牌中前 {FreeSha:diff()} 张杀本回合变为 0 费。"),
        ...
        ["SANGUOSHA_CARD_BA_GUA_CARD.description"] = new("cards", "装备：防具。敌人攻击你时，从抽牌堆顶依次判定；若为闪，获得 {Block:diff()} 点格挡并继续，直到本次攻击被完全格挡或判定牌不是闪。失去时抽牌并获得格挡。"),
        ["SANGUOSHA_CARD_REN_WANG_CARD.title"] = new("cards", "仁王盾"),
        ["SANGUOSHA_CARD_REN_WANG_CARD.description"] = new("cards", "装备：防具。获得 {Block:diff()} 点格挡。每回合首次即将受到杀或普通攻击伤害时，获得等同本次伤害量外加 {Guard:diff()} 点的格挡；升级后触发时抽 {Draw:diff()} 张牌。失去时获得格挡并抽牌。"),
        ["SANGUOSHA_CARD_BAI_YIN_CARD.title"] = new("cards", "白银狮子"),
        ["SANGUOSHA_CARD_BAI_YIN_CARD.description"] = new("cards", "装备：防具。获得 {Dexterity:diff()} 点敏捷并回复 {Heal:diff()} 点生命。每回合开始时回复 {TurnHeal:diff()} 点生命。每回合失去的总生命不超过 20 点，升级后不超过 15 点。"),
        ["SANGUOSHA_CARD_BING_LIANG_CARD.title"] = new("cards", "兵粮寸断"),
        ["SANGUOSHA_CARD_BING_LIANG_CARD.description"] = new("cards", "判定抽牌堆顶 1 张牌并置入弃牌堆。若判定牌费用为 0，抽 {Draw:diff()} 张牌；否则施加 {Weak:diff()} 层虚弱和 {Slow:diff()} 层减速。若判定牌是锦囊、能力牌或费用不低于 2，额外施加 {JudgedWeak:diff()} 层虚弱和 {JudgedSlow:diff()} 层减速。"),
        ["SANGUOSHA_CARD_CHI_TU_CARD.title"] = new("cards", "赤兔"),
        ["SANGUOSHA_CARD_CHI_TU_CARD.description"] = new("cards", "装备：坐骑。获得 {Strength:diff()} 点力量和 {Energy:diff()} 点能量。"),
        ["SANGUOSHA_CARD_DA_WAN_CARD.title"] = new("cards", "大宛"),
        ["SANGUOSHA_CARD_DA_WAN_CARD.description"] = new("cards", "装备：坐骑。获得 {Strength:diff()} 点力量。"),
        ...
        ["SANGUOSHA_CARD_YU_XI_CARD.description"] = new("cards", "装备：宝物。获得 {Energy:diff()} 点能量、{Strength:diff()} 点力量并抽 {Draw:diff()} 张牌。每回合开始时额外获得 1 点能量。"),
        ["SANGUOSHA_CARD_MU_NIU_CARD.title"] = new("cards", "木牛流马"),
        ["SANGUOSHA_CARD_MU_NIU_CARD.description"] = new("cards", "装备：宝物。获得 {Energy:diff()} 点能量并抽 {Draw:diff()} 张牌。每回合前 {TrickDraws:diff()} 次打出锦囊牌后，抽 1 张牌。"),
        ...
        ["SANGUOSHA_CARD_GUAN_SHI_CARD.description"] = new("cards", "装备：武器。获得 {Strength:diff()} 点力量和 {Energy:diff()} 点能量。杀命中有格挡的敌人时额外造成 {BonusDamage:diff()} 点伤害。"),
        ["SANGUOSHA_CARD_GU_DING_CARD.title"] = new("cards", "古锭刀"),
        ["SANGUOSHA_CARD_GU_DING_CARD.description"] = new("cards", "装备：武器。获得 {Strength:diff()} 点力量。杀命中没有格挡的敌人时，造成 150% 伤害。"),
        ...
        ["SANGUOSHA_CARD_TENG_JIA_CARD.description"] = new("cards", "装备：防具。获得 {Block:diff()} 点格挡。每回合开始时获得 {Block:diff()} 点格挡并失去 {HpLoss:diff()} 点生命。失去时获得格挡。"),
        ...
        ["SANGUOSHA_CARD_MENG_DE_XIN_SHU_CARD.description"] = new("cards", "装备：宝物。获得 {Energy:diff()} 点能量并抽 {Draw:diff()} 张牌。每回合首次打出锦囊牌后，获得 1 点能量，并使至多 {FreeCards:diff()} 张杀或锦囊牌本回合变为 0 费。失去时获得能量并临时减费。"),
        ...
        ["SANGUOSHA_CARD_HUO_GONG_CARD.description"] = new("cards", "可弃 1 张手牌。造成 {Damage:diff()} 点伤害并施加 {Poison:diff()} 层中毒；弃牌的费用和稀有度会提高伤害与中毒。若弃杀，额外造成 {AttackBonus:diff()} 点伤害；若弃闪，获得格挡；若弃能力牌，施加 {Vulnerable:diff()} 层易伤。"),
        ["SANGUOSHA_CARD_JIE_DAO_CARD.title"] = new("cards", "借刀杀人"),
        ["SANGUOSHA_CARD_JIE_DAO_CARD.description"] = new("cards", "可消耗至多 {MaxSha:diff()} 张手牌中的杀。造成 {Damage:diff()} 点伤害；每消耗 1 张杀，额外造成 {BonusDamage:diff()} 点伤害，并对所有敌人施加 {Slow:diff()} 层减速。若没有消耗杀，抽 {Draw:diff()} 张牌。"),
        ["SANGUOSHA_CARD_LE_BU_CARD.title"] = new("cards", "乐不思蜀"),
        ["SANGUOSHA_CARD_LE_BU_CARD.description"] = new("cards", "判定抽牌堆顶 1 张牌并置入弃牌堆。施加 {Slow:diff()} 层减速；若判定牌不是杀，额外施加 {JudgedSlow:diff()} 层减速和 {Vulnerable:diff()} 层易伤，造成 {Damage:diff()} 点伤害并获得 {Energy:diff()} 点能量。若判定牌是杀，抽 {Draw:diff()} 张牌。"),
        ...
        ["SANGUOSHA_CARD_QING_GANG_CARD.description"] = new("cards", "装备：武器。获得 {Energy:diff()} 点能量。你的杀无视敌人格挡。"),
        ["SANGUOSHA_CARD_SHAN_DIAN_CARD.title"] = new("cards", "闪电"),
        ["SANGUOSHA_CARD_SHAN_DIAN_CARD.description"] = new("cards", "判定抽牌堆顶 1 张牌并置入弃牌堆。造成 {Damage:diff()} 点基础伤害，判定牌费用和稀有度越高伤害越高；若判定牌是稀有牌或能力牌，额外造成 {CriticalDamage:diff()} 点伤害并施加 {Vulnerable:diff()} 层易伤。若无牌可判定，获得 {Block:diff()} 点格挡。"),
        ["SANGUOSHA_CARD_TIE_SUO_CARD.title"] = new("cards", "铁索连环"),
        ["SANGUOSHA_CARD_TIE_SUO_CARD.description"] = new("cards", "施加 {Slow:diff()} 层减速。本回合你的杀会对其他敌人造成 {SplashPercent:diff()}% 伤害。判定抽牌堆顶 1 张牌并置入弃牌堆；若判定牌是锦囊牌或能力牌，其他敌人受到 {Damage:diff()} 点伤害并获得 {Energy:diff()} 点能量，否则抽 {Draw:diff()} 张牌。"),
        ["SANGUOSHA_CARD_SHUN_SHOU_CARD.title"] = new("cards", "顺手牵羊"),
        ["SANGUOSHA_CARD_SHUN_SHOU_CARD.description"] = new("cards", "移除目标至多 {Block:diff()} 点格挡并获得等量格挡，造成 {Damage:diff()} 点伤害，抽 {Draw:diff()} 张牌。若成功偷取格挡，获得 {Energy:diff()} 点能量；否则使手牌中至多 {FreeCards:diff()} 张牌本回合变为 0 费。"),
        ...
        ["SANGUOSHA_CARD_KONG_CHENG_CARD.description"] = new("cards", "能力牌。获得 {Block:diff()} 点格挡。每回合首次在你打出牌结算后没有手牌时，获得 {Intangible:diff()} 层无实体。"),
        ["SANGUOSHA_CARD_LONG_DAN_CARD.title"] = new("cards", "龙胆"),
        ["SANGUOSHA_CARD_LONG_DAN_CARD.description"] = new("cards", "获得 {Block:diff()} 点格挡。可消耗任意张手牌中的杀或闪：每消耗 1 张杀，生成 1 张本回合 0 费闪；每消耗 1 张闪，生成 1 张本回合 0 费杀。升级后抽 {Draw:diff()} 张牌。"),
        ["SANGUOSHA_CARD_ZHI_HENG_CARD.title"] = new("cards", "制衡"),
        ["SANGUOSHA_CARD_ZHI_HENG_CARD.description"] = new("cards", "能力牌。可消耗至多 {MaxCards:diff()} 张手牌，抽等量牌并额外抽 {DrawBonus:diff()} 张。此后每回合首次打出锦囊牌后抽牌。"),
        ["SANGUOSHA_CARD_WU_SHUANG_CARD.title"] = new("cards", "无双"),
        ["SANGUOSHA_CARD_WU_SHUANG_CARD.description"] = new("cards", "能力牌。获得 {Strength:diff()} 点力量。每回合前 {Repeats:diff()} 次杀命中后追加一次无双伤害。"),
        ["SANGUOSHA_CARD_LIAN_YING_CARD.title"] = new("cards", "连营"),
        ["SANGUOSHA_CARD_LIAN_YING_CARD.description"] = new("cards", "能力牌。抽 1 张牌。每回合前 {Triggers:diff()} 次你打出牌后没有手牌时，抽 {Draw:diff()} 张牌，并使其中 1 张杀或锦囊牌本回合变为 0 费。"),
        ["SANGUOSHA_CARD_YI_JI_CARD.title"] = new("cards", "遗计"),
        ["SANGUOSHA_CARD_YI_JI_CARD.description"] = new("cards", "能力牌。抽 1 张牌。每回合首次敌人即将对你造成伤害时，抽 {Draw:diff()} 张牌；若手牌不多，额外抽 {LowHandDraw:diff()} 张牌，并使至多 {FreeCards:diff()} 张杀或锦囊牌本回合变为 0 费。"),
        ...
        ["SANGUOSHA_CARD_GUI_CAI_CARD.description"] = new("cards", "能力牌。获得 {Block:diff()} 点格挡。敌人即将对你造成伤害时，判定抽牌堆顶 1 张牌并置入弃牌堆：若为锦囊牌或能力牌，获得 {Block:diff()} 点格挡并抽 {Draw:diff()} 张牌；若为杀，施加 {Weak:diff()} 层虚弱；否则使 1 张杀或锦囊牌本回合变为 0 费。"),
        ["SANGUOSHA_CARD_CI_SHA_CARD.title"] = new("cards", "刺杀"),
        ["SANGUOSHA_CARD_CI_SHA_CARD.description"] = new("cards", "造成 {Damage:diff()} 点伤害。若目标没有格挡，额外造成 {BonusDamage:diff()} 点伤害。"),
        ["SANGUOSHA_CARD_SHOU_SHI_CARD.title"] = new("cards", "守势"),
        ["SANGUOSHA_CARD_SHOU_SHI_CARD.description"] = new("cards", "获得 {Block:diff()} 点格挡。若本回合还没有打出过杀，抽 {Draw:diff()} 张牌。"),
        ...
        ["SANGUOSHA_CARD_REN_DE_CARD.description"] = new("cards", "弃 1 张手牌，回复 {Heal:diff()} 点生命并抽 {Draw:diff()} 张牌。若弃杀，下一张杀额外造成 {NextShaDamage:diff()} 点伤害；若弃闪，获得 {Block:diff()} 点格挡；若弃锦囊，获得 {Energy:diff()} 点能量。"),
        ["SANGUOSHA_CARD_TU_XI_CARD.title"] = new("cards", "突袭"),
        ["SANGUOSHA_CARD_TU_XI_CARD.description"] = new("cards", "抽 {Draw:diff()} 张牌。若目标有格挡，移除其所有格挡；若目标没有格挡，获得 {Energy:diff()} 点能量，并根据目标状态削减力量或施加 {Vulnerable:diff()} 层易伤。"),
        ["SANGUOSHA_CARD_QI_XI_CARD.title"] = new("cards", "奇袭"),
        ["SANGUOSHA_CARD_QI_XI_CARD.description"] = new("cards", "消耗 1 张锦囊牌，若目标有格挡，移除其所有格挡并施加 {Vulnerable:diff()} 层易伤；若目标没有格挡，抽 {Draw:diff()} 张牌并获得 1 点能量。"),
        ...
        ["SANGUOSHA_POWER_ZHU_GE_DISPLAY_POWER.description"] = new("powers", "装备：武器。每回合开始时，手牌中前若干张杀本回合变为 0 费。失去时按本回合已打出的杀抽牌。"),
        ...
        ["SANGUOSHA_POWER_GUAN_SHI_DISPLAY_POWER.description"] = new("powers", "装备：武器。你的杀命中有格挡的敌人时额外造成伤害。失去时获得力量并强化下一张杀。"),
        ...
        ["SANGUOSHA_POWER_QI_LIN_DISPLAY_POWER.description"] = new("powers", "装备：武器。你的杀命中负面状态目标时追加伤害；每回合首次如此命中时施加易伤。失去时获得力量并抽牌。"),
        ["SANGUOSHA_POWER_GU_DING_DISPLAY_POWER.title"] = new("powers", "古锭刀"),
        ["SANGUOSHA_POWER_GU_DING_DISPLAY_POWER.description"] = new("powers", "装备：武器。你的杀命中无格挡目标时造成 150% 伤害。"),
        ...
        ["SANGUOSHA_POWER_BAI_YIN_DISPLAY_POWER.description"] = new("powers", "装备：防具。回合开始回复生命；每回合失去的总生命不超过上限。"),
        ["SANGUOSHA_POWER_REN_WANG_DISPLAY_POWER.title"] = new("powers", "仁王盾"),
        ["SANGUOSHA_POWER_REN_WANG_DISPLAY_POWER.description"] = new("powers", "装备：防具。每回合首次即将受到杀或普通攻击伤害时，获得足量格挡；升级后触发时抽牌。失去时获得格挡并抽牌。"),
        ["SANGUOSHA_POWER_BA_GUA_DISPLAY_POWER.title"] = new("powers", "八卦阵"),
        ["SANGUOSHA_POWER_BA_GUA_DISPLAY_POWER.description"] = new("powers", "装备：防具。敌人攻击你时，从抽牌堆顶判定；每打出 1 张闪获得格挡，并持续判定到攻击被完全格挡或翻出非闪。失去时抽牌并获得格挡。"),
        ["SANGUOSHA_POWER_TENG_JIA_DISPLAY_POWER.title"] = new("powers", "藤甲"),
        ["SANGUOSHA_POWER_TENG_JIA_DISPLAY_POWER.description"] = new("powers", "装备：防具。每回合开始时获得 10 点格挡并失去 1 点生命。失去时获得格挡。"),
        ["SANGUOSHA_POWER_CHI_TU_DISPLAY_POWER.title"] = new("powers", "赤兔"),
        ["SANGUOSHA_POWER_CHI_TU_DISPLAY_POWER.description"] = new("powers", "装备：坐骑。当前提供力量和能量。失去时获得能量，并使手牌中的杀临时变为 0 费。"),
        ["SANGUOSHA_POWER_DA_WAN_DISPLAY_POWER.title"] = new("powers", "大宛"),
        ["SANGUOSHA_POWER_DA_WAN_DISPLAY_POWER.description"] = new("powers", "装备：坐骑。当前提供力量。失去时获得力量，并强化下一张杀。"),
        ["SANGUOSHA_POWER_DI_LU_DISPLAY_POWER.title"] = new("powers", "的卢"),
        ["SANGUOSHA_POWER_DI_LU_DISPLAY_POWER.description"] = new("powers", "装备：坐骑。当前提供敏捷。失去时获得敏捷和格挡。"),
        ...
        ["SANGUOSHA_POWER_YU_XI_DISPLAY_POWER.description"] = new("powers", "装备：宝物。每回合开始额外获得能量。失去时获得能量并抽牌。"),
        ["SANGUOSHA_POWER_MU_NIU_DISPLAY_POWER.title"] = new("powers", "木牛流马"),
        ["SANGUOSHA_POWER_MU_NIU_DISPLAY_POWER.description"] = new("powers", "装备：宝物。每回合前若干次打出锦囊牌后抽牌。失去时抽牌。"),
        ...
        ["SANGUOSHA_POWER_MENG_DE_XIN_SHU_DISPLAY_POWER.description"] = new("powers", "装备：宝物。每回合首次打出锦囊牌后获得能量，并使杀或锦囊牌本回合变为 0 费。失去时获得能量并临时减费。"),
        ...
        ["SANGUOSHA_POWER_ZHI_HENG_DISPLAY_POWER.description"] = new("powers", "能力牌。每回合首次打出锦囊牌后抽牌。"),
        ["SANGUOSHA_POWER_WU_SHUANG_DISPLAY_POWER.title"] = new("powers", "无双"),
        ["SANGUOSHA_POWER_WU_SHUANG_DISPLAY_POWER.description"] = new("powers", "能力牌。每回合前若干次杀命中后追加无双伤害。"),
        ["SANGUOSHA_POWER_LIAN_YING_DISPLAY_POWER.title"] = new("powers", "连营"),
        ["SANGUOSHA_POWER_LIAN_YING_DISPLAY_POWER.description"] = new("powers", "能力牌。打出牌后若没有手牌，抽牌并让 1 张杀或锦囊牌本回合变为 0 费。"),
        ["SANGUOSHA_POWER_YI_JI_DISPLAY_POWER.title"] = new("powers", "遗计"),
        ["SANGUOSHA_POWER_YI_JI_DISPLAY_POWER.description"] = new("powers", "能力牌。每回合首次敌人即将造成伤害时抽牌，手牌少时额外抽牌并临时减费。"),
        ...
        ["IRONCLAD.description"] = new("characters", "赤壁猛将以血火开锋：所有杀视为火杀，命中后追加火焰伤害；生命不高于一半时，每回合首次火杀施加易伤。"),
        ["SILENT.title"] = new("characters", "锦囊夜行"),
        ["SILENT.titleObject"] = new("characters", "锦囊夜行"),
        ["SILENT.description"] = new("characters", "锦囊夜行以暗谋入局：所有杀视为毒杀，命中后施加中毒；攻击已中毒的敌人时每回合首次回复能量。"),
        ["DEFECT.title"] = new("characters", "机关卧龙"),
        ["DEFECT.titleObject"] = new("characters", "机关卧龙"),
        ["DEFECT.description"] = new("characters", "机关卧龙以奇门驭雷：所有杀视为雷杀，命中后连锁电击全场并积累雷势，雷势满时爆发全体伤害。"),
        ["NECROBINDER.title"] = new("characters", "青囊魂医"),
        ["NECROBINDER.titleObject"] = new("characters", "青囊魂医"),
        ["NECROBINDER.description"] = new("characters", "青囊魂医以魂术济危：所有杀视为灾厄杀，命中后施加虚弱和减速，并以魂值换取吸血式追击。"),
        ["REGENT.title"] = new("characters", "汉室仁主"),
        ["REGENT.titleObject"] = new("characters", "汉室仁主"),
        ["REGENT.description"] = new("characters", "汉室仁主以王道统御：所有杀视为储能杀，并用号令、星辉和交替出牌扩大团队节奏；星辉达到 3 时发动诏令。"),

        ["SANGUOSHA_RELIC_IRONCLAD_SKILL_RELIC.title"] = new("relics", "武魂：火杀"),
        ["SANGUOSHA_RELIC_IRONCLAD_SKILL_RELIC.description"] = new("relics", "赤壁猛将的武魂。战斗开始获得 1 点力量；你的杀均为火杀，命中后追加 2 点伤害。生命不高于一半时追加伤害提高到 3，且每回合首次火杀再追加 1 点伤害并施加 1 层易伤。"),
        ["SANGUOSHA_RELIC_IRONCLAD_SKILL_RELIC.flavor"] = new("relics", "血火铸甲，赤壁开锋。"),
        ["SANGUOSHA_RELIC_SILENT_SKILL_RELIC.title"] = new("relics", "武魂：毒杀"),
        ["SANGUOSHA_RELIC_SILENT_SKILL_RELIC.description"] = new("relics", "锦囊夜行的武魂。战斗开始抽 1 张牌并获得机巧；你的杀均为毒杀，命中后施加 3 层中毒。若目标已中毒，每回合首次毒杀回复 1 点能量。"),
        ["SANGUOSHA_RELIC_SILENT_SKILL_RELIC.flavor"] = new("relics", "胜负不在手牌里，在别人以为你没有手牌时。"),
        ["SANGUOSHA_RELIC_DEFECT_SKILL_RELIC.title"] = new("relics", "武魂：雷杀"),
        ["SANGUOSHA_RELIC_DEFECT_SKILL_RELIC.description"] = new("relics", "机关卧龙的武魂。战斗开始获得雷势；你的杀均为雷杀，命中后对目标追加 1 点雷击、对其他敌人追加 2 点雷击并获得雷势。雷势达到 4 时消耗 4，对所有敌人造成 8 点伤害。"),
        ["SANGUOSHA_RELIC_DEFECT_SKILL_RELIC.flavor"] = new("relics", "风起之前，星位已经变了。"),
        ["SANGUOSHA_RELIC_NECROBINDER_SKILL_RELIC.title"] = new("relics", "武魂：灾厄杀"),
        ["SANGUOSHA_RELIC_NECROBINDER_SKILL_RELIC.description"] = new("relics", "青囊魂医的武魂。战斗开始回复生命并获得魂值；你的杀均为灾厄杀，命中后施加 1 层虚弱和 1 层减速并获得魂值。魂值达到 4 时消耗 4，回复 2 点生命并追加 4 点伤害。"),
        ["SANGUOSHA_RELIC_NECROBINDER_SKILL_RELIC.flavor"] = new("relics", "刀兵之后，总有人要把命从鬼门关边上拉回来。"),
        ["SANGUOSHA_RELIC_REGENT_SKILL_RELIC.title"] = new("relics", "武魂：储能杀"),
        ["SANGUOSHA_RELIC_REGENT_SKILL_RELIC.description"] = new("relics", "汉室仁主的武魂。战斗开始获得号令和星辉；你的杀均为储能杀，命中后追加较少的号令伤害并获得储能。每 2 点储能自动消耗，获得 1 点能量并抽 1 张牌。星辉达到 3 时消耗 3，发动诏令：获得 1 点能量、抽 1 张牌、提升 1 点号令，并使 1 张杀或锦囊本回合免费。"),
    ...
    {
        ["SANGUOSHA_CARD_WU_GU_CARD.description"] = new("cards", "获得 {Block:diff()} 点格挡。可消耗手牌中的 1 张牌。所有玩家抽 {Draw:diff()} 张牌；若成功消耗，获得 {Energy:diff()} 点能量，所有玩家额外抽 {BonusDraw:diff()} 张牌。"),
