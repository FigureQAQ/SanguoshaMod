...
internal static class SanguoshaLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, Entry> Text = new Dictionary<string, Entry>
    {
        ...
        ["SANGUOSHA_CARD_WANG_JIAN_SHA_CARD.description"] = new("cards", "储君生成牌。视为杀造成 {Damage:diff()} 点伤害。"),
        ...
        ["SANGUOSHA_POWER_REGENT_SKILL_DISPLAY_POWER.description"] = new("powers", "杀附魔：君王之剑。杀命中后获得等同杀数值的剑势；剑势达到 12 时生成 1 张 0 费王剑杀。"),

        ["IRONCLAD.title"] = new("characters", "赤壁猛将"),
        ["IRONCLAD.titleObject"] = new("characters", "赤壁猛将"),
        ["IRONCLAD.description"] = new("characters", "武魂：火杀。战斗开始获得力量，杀命中追加火焰伤害。"),
        ["SILENT.title"] = new("characters", "锦囊夜行"),
        ["SILENT.titleObject"] = new("characters", "锦囊夜行"),
        ["SILENT.description"] = new("characters", "武魂：毒杀。战斗开始抽牌，杀命中施加中毒；每回合首次技能牌抽牌。"),
        ["DEFECT.title"] = new("characters", "机关卧龙"),
        ["DEFECT.titleObject"] = new("characters", "机关卧龙"),
        ["DEFECT.description"] = new("characters", "武魂：雷杀。杀命中积累雷势并追加雷击；雷势满 4 后释放群体伤害。"),
        ["NECROBINDER.title"] = new("characters", "青囊魂医"),
        ["NECROBINDER.titleObject"] = new("characters", "青囊魂医"),
        ["NECROBINDER.description"] = new("characters", "武魂：灾厄杀。杀命中施加灾厄；闪会令所有敌人失去生命。"),
        ["REGENT.title"] = new("characters", "汉室仁主"),
        ["REGENT.titleObject"] = new("characters", "汉室仁主"),
        ["REGENT.description"] = new("characters", "武魂：君王之剑。杀命中后获得剑势，剑势足够时生成王剑杀。"),
        ...
        ["SANGUOSHA_RELIC_REGENT_SKILL_RELIC.description"] = new("relics", "杀附魔：君王之剑。杀命中后获得等同杀数值的剑势；剑势达到 12 时生成 1 张 0 费王剑杀。"),
