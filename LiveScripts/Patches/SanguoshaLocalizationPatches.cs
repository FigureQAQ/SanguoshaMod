...
internal static class SanguoshaLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, Entry> Text = new Dictionary<string, Entry>
    {
        ...
        ["SANGUOSHA_CARD_QING_GANG_CARD.description"] = new("cards", "装备：武器。获得 {Energy:diff()} 点能量。你的杀无视目标格挡。升级后，若目标原本有格挡，造成 150% 伤害。"),
        ...
        ["SANGUOSHA_POWER_QING_GANG_DISPLAY_POWER.description"] = new("powers", "装备：武器。你的杀无视目标格挡；升级后，若目标原本有格挡，造成 150% 伤害。"),
