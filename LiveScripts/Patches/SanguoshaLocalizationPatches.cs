...
internal static class SanguoshaLocalization
{
    ...
    {
        ["CARD_TYPE.SKILL"] = new("gameplay_ui", "锦囊牌"),
        ["TYPE_SKILL_TIP"] = new("card_library", "锦囊牌"),
        ...
        ["SANGUOSHA_CARD_JIU_CARD.description"] = new("cards", "你的下一张攻击牌造成的伤害翻倍。"),
        ...
        ["SANGUOSHA_CARD_BAI_YIN_CARD.description"] = new("cards", "装备：防具。获得 {Dexterity:diff()} 点敏捷并回复 {Heal:diff()} 点生命。每回合开始时回复 {TurnHeal:diff()} 点生命。每回合失去的总生命有上限。"),
        ...
        ["SANGUOSHA_CARD_LONG_DAN_CARD.description"] = new("cards", "获得 {Block:diff()} 点格挡。可消耗任意张手牌中的杀或闪：每消耗 1 张杀，生成 1 张本回合 0 费闪；每消耗 1 张闪，生成 1 张本回合 0 费杀。"),
