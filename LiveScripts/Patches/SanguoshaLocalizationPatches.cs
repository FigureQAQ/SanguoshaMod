...
internal static class SanguoshaLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, Entry> Text = new Dictionary<string, Entry>
    {
        ...
        ["SANGUOSHA_CARD_DA_WAN_CARD.description"] = new("cards", "装备：坐骑。获得 {Strength:diff()} 点力量。你的杀额外造成 {BonusDamage:diff()} 点伤害。失去时获得 1 点力量并强化下一张杀。"),
        ...
        ["SANGUOSHA_CARD_HUO_GONG_CARD.description"] = new("cards", "可弃 1 张手牌。造成 {Damage:diff()} 点伤害并施加 {Poison:diff()} 层中毒；弃牌的费用和稀有度会提高伤害与中毒。若弃的是杀，额外造成 {AttackBonus:diff()} 点伤害；若弃的是闪，获得格挡；若弃的是能力牌，施加 {Vulnerable:diff()} 层易伤。"),
        ...
        ["SANGUOSHA_CARD_TIE_SUO_CARD.description"] = new("cards", "施加 {Slow:diff()} 层减速。本回合你的杀会对其他敌人造成 {SplashPercent:diff()}% 溅射伤害；溅射不触发杀命中、武魂或武器追击。判定抽牌堆顶 1 张牌并置入弃牌堆；若判定牌是技能牌或能力牌，其他敌人受到 {Damage:diff()} 点伤害并获得 {Energy:diff()} 点能量，否则抽 {Draw:diff()} 张牌。"),
        ...
        ["SANGUOSHA_POWER_DA_WAN_DISPLAY_POWER.description"] = new("powers", "装备：坐骑。你的杀额外造成伤害。失去时获得力量，并强化下一张杀。"),
