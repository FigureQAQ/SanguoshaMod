...
internal static class SanguoshaLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, Entry> Text = new Dictionary<string, Entry>
    {
        ...
        ["SANGUOSHA_CARD_WU_ZHONG_CARD.description"] = new("cards", "可消耗手牌中的 1 张牌。若如此做，获得 {Energy:diff()} 点能量。抽 {Draw:diff()} 张牌。"),
        ["SANGUOSHA_CARD_WU_GU_CARD.title"] = new("cards", "五谷丰登"),
        ["SANGUOSHA_CARD_WU_GU_CARD.description"] = new("cards", "获得 {Block:diff()} 点格挡。可消耗手牌中的 1 张牌。若如此做，你获得 {Energy:diff()} 点能量。所有玩家抽 {Draw:diff()} 张牌并获得 {GoodLuck:diff()} 层好运。"),
        ...
        ["SANGUOSHA_CARD_ZHI_HENG_CARD.description"] = new("cards", "能力牌。可消耗手牌中至多 {MaxCards:diff()} 张牌；抽等量牌并额外抽 {DrawBonus:diff()} 张。此后每回合首次打出技能牌后抽牌。"),
        ...
        ["SANGUOSHA_CARD_YI_JI_CARD.description"] = new("cards", "能力牌。抽 1 张牌。此后每回合首次敌人即将对你造成可被格挡的伤害时，抽 {Draw:diff()} 张牌；若触发前手牌不超过 3 张，额外抽 {LowHandDraw:diff()} 张。然后使手牌中至多 {FreeCards:diff()} 张杀或技能牌本回合变为 0 费。"),
        ...
        ["SANGUOSHA_CARD_JI_XING_CARD.description"] = new("cards", "消耗。获得 {Energy:diff()} 点能量。升级后抽 {Draw:diff()} 张牌。"),
        ["SANGUOSHA_CARD_FEN_YING_CARD.title"] = new("cards", "焚营"),
        ["SANGUOSHA_CARD_FEN_YING_CARD.description"] = new("cards", "能力牌。获得 {Block:diff()} 点格挡。此后每当你消耗手牌中的牌，获得 {ExhaustBlock:diff()} 点格挡。"),
        ["SANGUOSHA_CARD_PO_ZHU_CARD.title"] = new("cards", "破竹"),
        ["SANGUOSHA_CARD_PO_ZHU_CARD.description"] = new("cards", "施加 {Vulnerable:diff()} 层易伤。此后每当你施加易伤，每层易伤获得 {Strength:diff()} 点力量。"),
        ...
        ["SANGUOSHA_CARD_TU_XI_CARD.description"] = new("cards", "移除目标所有格挡。抽 {Draw:diff()} 张牌并施加 {Vulnerable:diff()} 层易伤。"),
        ["SANGUOSHA_CARD_QI_XI_CARD.title"] = new("cards", "奇袭"),
        ["SANGUOSHA_CARD_QI_XI_CARD.description"] = new("cards", "消耗手牌中的 1 张技能牌。移除目标所有格挡，施加 {Vulnerable:diff()} 层易伤并抽 {Draw:diff()} 张牌。"),
        ...
        ["SANGUOSHA_CARD_XU_SHI_CARD.description"] = new("cards", "下一张杀额外造成 {NextShaDamage:diff()} 点伤害。若手牌中没有其他杀，抽 {Draw:diff()} 张牌。"),
        ["SANGUOSHA_CARD_PO_ZHEN_CARD.title"] = new("cards", "破阵"),
        ["SANGUOSHA_CARD_PO_ZHEN_CARD.description"] = new("cards", "移除目标所有格挡，施加 {Vulnerable:diff()} 层易伤。若移除了格挡，抽 {Draw:diff()} 张牌。"),
        ...
        ["SANGUOSHA_CARD_YING_ZI_CARD.description"] = new("cards", "能力牌。每回合开始时抽 {Draw:diff()} 张牌。"),
        ["SANGUOSHA_CARD_JI_ZHI_CARD.title"] = new("cards", "集智"),
        ["SANGUOSHA_CARD_JI_ZHI_CARD.description"] = new("cards", "能力牌。抽 1 张牌。每回合首次打出技能牌后，抽 {Draw:diff()} 张牌。"),
        ["SANGUOSHA_CARD_LUO_YI_CARD.title"] = new("cards", "裸衣"),
        ["SANGUOSHA_CARD_LUO_YI_CARD.description"] = new("cards", "能力牌。每回合开始时，你的下一张杀额外造成 {NextShaDamage:diff()} 点伤害。"),
        ["SANGUOSHA_CARD_TIE_QI_CARD.title"] = new("cards", "铁骑"),
        ["SANGUOSHA_CARD_TIE_QI_CARD.description"] = new("cards", "能力牌。每回合首次杀命中后，施加 {Vulnerable:diff()} 层易伤。"),
        ["SANGUOSHA_CARD_QING_NANG_CARD.title"] = new("cards", "青囊"),
        ["SANGUOSHA_CARD_QING_NANG_CARD.description"] = new("cards", "能力牌。回复 {Heal:diff()} 点生命。每回合开始时回复 {Heal:diff()} 点生命。"),
        ["SANGUOSHA_CARD_XIAO_JI_CARD.title"] = new("cards", "枭姬"),
        ["SANGUOSHA_CARD_XIAO_JI_CARD.description"] = new("cards", "能力牌。获得 {Energy:diff()} 点能量。每当你替换装备时，抽 {Draw:diff()} 张牌。"),
        ["SANGUOSHA_CARD_BATH_OF_BLOOD_CARD.title"] = new("cards", "浴血形态"),
        ["SANGUOSHA_CARD_BATH_OF_BLOOD_CARD.description"] = new("cards", "Boss奖励。能力牌。每回合开始时失去 {HpLoss:diff()} 点生命，获得 {Energy:diff()} 点能量。"),
        ["SANGUOSHA_CARD_NIGHTFALL_SCHEME_CARD.title"] = new("cards", "夜幕形态"),
        ["SANGUOSHA_CARD_NIGHTFALL_SCHEME_CARD.description"] = new("cards", "Boss奖励。能力牌。每回合开始时抽 {Draw:diff()} 张牌，对所有敌人施加 {Poison:diff()} 层中毒。"),
        ["SANGUOSHA_CARD_THUNDER_MANDATE_CARD.title"] = new("cards", "雷诏形态"),
        ["SANGUOSHA_CARD_THUNDER_MANDATE_CARD.description"] = new("cards", "Boss奖励。能力牌。每回合开始时获得 {Thunder:diff()} 点雷势，对所有敌人造成 {Damage:diff()} 点伤害。"),
        ["SANGUOSHA_CARD_SOUL_HEALER_FORM_CARD.title"] = new("cards", "魂医形态"),
        ["SANGUOSHA_CARD_SOUL_HEALER_FORM_CARD.description"] = new("cards", "Boss奖励。能力牌。每回合开始时回复 {Heal:diff()} 点生命，所有敌人失去 {HpLoss:diff()} 点生命。"),
        ["SANGUOSHA_CARD_IMPERIAL_EDICT_CARD.title"] = new("cards", "诏令形态"),
        ["SANGUOSHA_CARD_IMPERIAL_EDICT_CARD.description"] = new("cards", "Boss奖励。能力牌。每回合开始时获得 {Energy:diff()} 点能量，你的下一张杀额外造成 {NextShaDamage:diff()} 点伤害。"),
        ...
        ["SANGUOSHA_POWER_MENG_DE_XIN_SHU_DISPLAY_POWER.description"] = new("powers", "装备：宝物。每回合首次打出技能牌后获得能量，并使若干张杀或技能牌本回合费用降低 1。失去时获得能量并临时降费。"),
        ...
        ["SANGUOSHA_POWER_YING_ZI_DISPLAY_POWER.description"] = new("powers", "能力牌。每回合开始时抽牌。"),
        ["SANGUOSHA_POWER_JI_ZHI_DISPLAY_POWER.title"] = new("powers", "集智"),
        ["SANGUOSHA_POWER_JI_ZHI_DISPLAY_POWER.description"] = new("powers", "能力牌。每回合首次打出技能牌后抽牌。"),
        ["SANGUOSHA_POWER_LUO_YI_DISPLAY_POWER.title"] = new("powers", "裸衣"),
        ["SANGUOSHA_POWER_LUO_YI_DISPLAY_POWER.description"] = new("powers", "能力牌。每回合开始时强化下一张杀。"),
        ["SANGUOSHA_POWER_TIE_QI_DISPLAY_POWER.title"] = new("powers", "铁骑"),
        ["SANGUOSHA_POWER_TIE_QI_DISPLAY_POWER.description"] = new("powers", "能力牌。每回合首次杀命中后施加易伤。"),
        ["SANGUOSHA_POWER_QING_NANG_DISPLAY_POWER.title"] = new("powers", "青囊"),
        ["SANGUOSHA_POWER_QING_NANG_DISPLAY_POWER.description"] = new("powers", "能力牌。每回合开始时回复生命。"),
        ["SANGUOSHA_POWER_XIAO_JI_DISPLAY_POWER.title"] = new("powers", "枭姬"),
        ["SANGUOSHA_POWER_XIAO_JI_DISPLAY_POWER.description"] = new("powers", "能力牌。每当你替换装备时抽牌。"),
        ["SANGUOSHA_POWER_BATH_OF_BLOOD_DISPLAY_POWER.title"] = new("powers", "浴血形态"),
        ["SANGUOSHA_POWER_BATH_OF_BLOOD_DISPLAY_POWER.description"] = new("powers", "每回合开始时失去生命并获得能量。"),
    ...
    private static readonly IReadOnlyDictionary<string, Entry> TextOverrides = new Dictionary<string, Entry>
    {
        ...
        ["SANGUOSHA_POWER_FEN_YING_DISPLAY_POWER.description"] = new("powers", "能力牌。每当你消耗手牌中的牌，获得格挡。"),
        ["SANGUOSHA_POWER_PO_ZHU_DISPLAY_POWER.title"] = new("powers", "破竹"),
        ["SANGUOSHA_POWER_PO_ZHU_DISPLAY_POWER.description"] = new("powers", "能力牌。每当你施加易伤，每层易伤获得力量。")
    };
