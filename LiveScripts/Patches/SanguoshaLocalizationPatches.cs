...
internal static class SanguoshaLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, Entry> Text = new Dictionary<string, Entry>
    {
        ...
        ["SANGUOSHA_POWER_IRONCLAD_SKILL_DISPLAY_POWER.description"] = new("powers", "杀附带火杀：命中后追加 2 点伤害；生命不高于 50% 时，每回合首次火杀改为追加 4 点伤害并施加 1 层易伤。回合开始若生命不高于 60%，获得 1 点力量。"),
        ["SANGUOSHA_POWER_SILENT_SKILL_DISPLAY_POWER.title"] = new("powers", "武魂：毒杀"),
        ["SANGUOSHA_POWER_SILENT_SKILL_DISPLAY_POWER.description"] = new("powers", "战斗开始抽 1 张牌并获得 2 点机巧。回合开始获得 2 点机巧，最多 5 点；手牌不超过 4 张时抽 1 张牌。杀附带毒杀：命中后施加中毒；每回合首次命中已有中毒的敌人时获得 1 点能量。"),
        ...
        ["SANGUOSHA_POWER_REGENT_SKILL_DISPLAY_POWER.description"] = new("powers", "战斗开始获得 1 点号令和 1 点星辉；回合开始获得 1 点星辉。杀附带储能杀：命中后获得 1 点铸剑；铸剑达到 3 时消耗 3 点并生成 1 张 0 费王剑杀。星辉达到 3 时每回合最多发动 1 次诏令。"),

        ["IRONCLAD.title"] = new("characters", "赤壁猛将"),
        ["IRONCLAD.titleObject"] = new("characters", "赤壁猛将"),
        ["IRONCLAD.description"] = new("characters", "武魂：火杀。杀命中追加火焰伤害；低生命时首次火杀强化并施加易伤，回合开始可获得力量。"),
        ["SILENT.title"] = new("characters", "锦囊夜行"),
        ["SILENT.titleObject"] = new("characters", "锦囊夜行"),
        ["SILENT.description"] = new("characters", "武魂：毒杀。依靠机巧、技能牌联动和中毒目标回能来滚动手牌与费用。"),
        ["DEFECT.title"] = new("characters", "机关卧龙"),
        ["DEFECT.titleObject"] = new("characters", "机关卧龙"),
        ["DEFECT.description"] = new("characters", "武魂：雷杀。杀命中积累雷势并造成连锁雷击；雷势满 4 后释放群体伤害。"),
        ...
        ["REGENT.description"] = new("characters", "武魂：储能杀。杀积累铸剑生成王剑杀；星辉满 3 发动诏令，提供能量、抽牌、号令和临时免费。"),
